...
import './PokedexImage.css';

export default class PokedexImage extends React.Component {
  render() {
    console.log('this.props PKDEX IMAGE', this.props)
    return (
      <div id="pokedex">
        <div id="left">
          <div id="logo"></div>
