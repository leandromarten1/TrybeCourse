...
// Exercise 2
db.bios.find({_id:8}, {name:1}).pretty(); // não precisa do _id: 1 pq ID sempre vem por default
...
// mongoimport --db NOME_DO_DB --collection NOME_DA_COLLECTION --file ARQUIVO.JSON
