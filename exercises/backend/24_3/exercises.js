...
db.movies.find(
  { ratings: { $elemMatch: { $gte: 103, $lte: 105 } } },
  { _id: 0, title: 1, ratings: 1 },
);

// 8 Retorne todos os filmes com ratings entre 64 e 105 e que é divisível por 9, exibindo apenas os campos title e ratings.
db.movies.find(
  {
    $and: [
...
// $mod pode ir depois de $lte. Eliminando o $and.
...
// 15 Adicione o campo description no filme Batman com o seguinte valor:
